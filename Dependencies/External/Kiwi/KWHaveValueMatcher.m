...
+ (NSArray*) matcherStrings {
    return [NSArray arrayWithObjects:@"haveValue:forKey:", @"haveValueForKey:", @"haveValue:forKeyPath:",
...
- (NSString*) failureMessageForShould {
    ...
    return [NSString stringWithFormat:@"expected subject to have value %@ for key %@", self.expectedValue,
                                      self.expectedKey];
}
