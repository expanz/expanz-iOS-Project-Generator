...
- (LRRestyRequest*) delete:(NSString*)urlString headers:(NSDictionary*)headers
                  delegate:(id<LRRestyClientResponseDelegate>)delegate; {
    return [HTTPClient DELETE:[NSURL URLWithString:urlString] headers:headers
...
- (LRRestyResponse*) delete:(NSString*)urlString; {
    return [self performAsynchronousBlockWithTimeout:globalTimeoutInterval
