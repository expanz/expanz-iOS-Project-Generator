...
+ (NSArray*) matcherStrings {
    return [NSArray arrayWithObjects:@"beLessThan:", @"beLessThanOrEqualTo:", @"beGreaterThan:",
...
- (BOOL) evaluate {
    ...
    switch (result) {
        case NSOrderedSame:
            return self.inequalityType == KWInequalityTypeLessThanOrEqualTo || self.inequalityType ==
                KWInequalityTypeGreaterThanOrEqualTo;
        case NSOrderedAscending:
            return self.inequalityType == KWInequalityTypeLessThan || self.inequalityType ==
                KWInequalityTypeLessThanOrEqualTo;
        case NSOrderedDescending:
            return self.inequalityType == KWInequalityTypeGreaterThan || self.inequalityType ==
                KWInequalityTypeGreaterThanOrEqualTo;
    }
...
- (NSString*) failureMessageForShould {
    return [NSString stringWithFormat:@"expected subject to be %@ %@, got %@", [self comparisonPhrase],
