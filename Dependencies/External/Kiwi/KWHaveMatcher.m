...
+ (NSArray*) matcherStrings {
    return [NSArray arrayWithObjects:@"haveCountOf:", @"haveCountOfAtLeast:", @"haveCountOfAtMost:",
                                     @"have:itemsForInvocation:", @"haveAtLeast:itemsForInvocation:",
...
- (NSString*) failureMessageForShould {
    return [NSString stringWithFormat:@"expected subject to %@ %u %@, got %@", [self verbPhrase], self.count,
                                      [self itemPhrase], [self actualCountPhrase]];
}

- (NSString*) failureMessageForShouldNot {
    return [NSString stringWithFormat:@"expected subject not to %@ %u %@", [self verbPhrase], self.count,
                                      [self itemPhrase]];
}
