...
/**
 ...
 @returns The request object.
 */
- (LRRestyRequest*) get:(NSString*)urlString parameters:(NSDictionary*)parameters
...
/**
 ...
 @returns The request object.
 */
- (LRRestyRequest*) get:(NSString*)urlString parameters:(NSDictionary*)parameters headers:(NSDictionary*)headers
               delegate:(id<LRRestyClientResponseDelegate>)delegate;
...
/**
 ...
 @returns The request object.
 */
- (LRRestyRequest*) get:(NSString*)urlString onData:(LRRestyStreamingDataBlock)dataHandler
                onError:(LRRestyStreamingErrorBlock)errorHandler;
 ...
 */
- (LRRestyRequest*) get:(NSString*)urlString withBlock:(LRRestyResponseBlock)block
                 onData:(LRRestyStreamingDataBlock)dataHandler;
@end
