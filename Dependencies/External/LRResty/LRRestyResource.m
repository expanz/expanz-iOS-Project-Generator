...
- (LRRestyResource*) at:(NSString*)path; {
    return [[[LRRestyResource alloc]
        initWithRestClient:restClient URL:[URL URLByAppendingPathComponent:path] parent:self] autorelease];
}
...
- (LRRestyRequest*) get:(LRRestyResourceResponseBlock)responseBlock; {
    ...
    LRRestyRequest* request =
        [restClient get:[URL absoluteString] parameters:nil headers:nil withBlock:^(LRRestyResponse* response) {
