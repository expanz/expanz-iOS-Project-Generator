...
#pragma mark Generic
            template < typename
            T, typename
            U > bool compare_greater_than(const T & actualValue, const U & expectedValue) {
...
#pragma mark NSNumber
            ...
            template < typename
            U > bool compare_greater_than(NSNumber* const actualValue, const U & expectedValue) {
            ...
            template < typename
            T > bool compare_greater_than(const T & actualValue, NSNumber* const expectedValue) {
