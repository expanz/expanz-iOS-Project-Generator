...
+ (id) contextNodeWithCallSite:(KWCallSite*)aCallSite parentContext:(KWContextNode*)contextNode
...
- (void) performExample:(KWExample*)example withBlock:(void (^)(void))exampleBlock {
    ...
    void (^outerExampleBlock)(void) = ^{
        ...
        @catch (NSException* exception) {
            KWFailure* failure =
                [KWFailure failureWithCallSite:self.callSite format:@"%@ \"%@\" raised", [exception name],
                                                                    [exception reason]];
